...
#if (GMAC_IP_CFG_VENDOR_ID != GMAC_IP_SA_PBCFG_BOARD_INITPERIPHERALS_VENDOR_ID)
    #error "Gmac_Ip_Cfg.h and Gmac_Ip_Sa_BOARD_InitPeripherals_PBcfg.h have different vendor ids"
#endif
#if ((GMAC_IP_CFG_AR_RELEASE_MAJOR_VERSION    != GMAC_IP_SA_PBCFG_BOARD_INITPERIPHERALS_AR_RELEASE_MAJOR_VERSION) || \
     (GMAC_IP_CFG_AR_RELEASE_MINOR_VERSION    != GMAC_IP_SA_PBCFG_BOARD_INITPERIPHERALS_AR_RELEASE_MINOR_VERSION) || \
     (GMAC_IP_CFG_AR_RELEASE_REVISION_VERSION != GMAC_IP_SA_PBCFG_BOARD_INITPERIPHERALS_AR_RELEASE_REVISION_VERSION))
     #error "AUTOSAR Version Numbers of Gmac_Ip_Cfg.h and Gmac_Ip_Sa_BOARD_InitPeripherals_PBcfg.h are different"
#endif
#if ((GMAC_IP_CFG_SW_MAJOR_VERSION != GMAC_IP_SA_PBCFG_BOARD_INITPERIPHERALS_SW_MAJOR_VERSION) || \
     (GMAC_IP_CFG_SW_MINOR_VERSION != GMAC_IP_SA_PBCFG_BOARD_INITPERIPHERALS_SW_MINOR_VERSION) || \
     (GMAC_IP_CFG_SW_PATCH_VERSION != GMAC_IP_SA_PBCFG_BOARD_INITPERIPHERALS_SW_PATCH_VERSION))
...
#define GMAC_DEV_ERROR_DETECT            (STD_OFF)
