...
#define LPSPI_IP_SA_SW_MAJOR_VERSION_PBCFG_C                 5
...
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_3_Instance_3 =
{
    3U,  /* Instance */
...
const Lpspi_Ip_ConfigType Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_3_Instance_3 =
{
    3U,  /* Instance */
     /* CR */
    (uint32)0,
