...
static const IntCtrl_Ip_IrqConfigType aIrqConfiguration1[] = {
    ...
    {EMAC_0_IRQn, (boolean)TRUE, 0U, &undefined_handler},
    {EMAC_1_IRQn, (boolean)TRUE, 0U, &undefined_handler},
    {EMAC_2_IRQn, (boolean)TRUE, 0U, &undefined_handler},
    {EMAC_3_IRQn, (boolean)TRUE, 0U, &undefined_handler},
