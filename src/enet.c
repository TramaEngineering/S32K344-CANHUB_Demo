...
uint8_t udpFrame128[14 + 20 + 8 + 128] = {
    ...
    0x10,0x11,0x22,0x88,0x88,0x88,  // Dest MAC
    0x66,0x55,0x44,0x33,0x22,0x11,  // Src MAC
	0x08,0x00,                        // EtherType = VLAN
	/*0x40,0x01,						//priotity-DEI-ID
	0x08,0x00,						//Ethertype = IPv4*/

    // IPv4 header (20B)
    0x45, 0x00, 0x00, 0x9C,  // Total length = 20+8+128 = 152 = 0x009c
    0x00,0x01, 0x40,0x00, 0x40,0x11, 0xB8,0x53,
    0xC0,0xA8,0x00,0x01,  // Src IP
    0xC0,0xA8,0x00,0x02,  // Dst IP
...
uint8_t udpFrame512[14 + 20 + 8 + 512] = {
    // Ethernet header (16B)
    0x10,0x11,0x22,0x88,0x88,0x88,  // Dest MAC
    0x66,0x55,0x44,0x33,0x22,0x11,  // Src MAC
	0x08,0x00,                        // EtherType = VLAN
...
uint8_t udpFrame1400[14 + 20 + 8 + 1400] = {
    // Ethernet header (16B)
    0x10,0x11,0x22,0x88,0x88,0x88,  // Dest MAC
    0x66,0x55,0x44,0x33,0x22,0x11,  // Src MAC
	0x08,0x00,                        // EtherType = VLAN
    ...
    // IPv4 header (20B)
    0x45, 0x00, 0x05, 0x94,  // Total length = 20+8+1400 = 1428 = 0x0590
    0x00,0x01, 0x40,0x00, 0x40,0x11, 0xB8,0x53,
    0xC0,0xA8,0x00,0x01,  // Src IP
    0xC0,0xA8,0x00,0x02,  // Dst IP
...
Gmac_Ip_BufferType customMessage_UDP_512 = { .Data = udpFrame512, .Length = 14 + 20 + 8 + 512 };
Gmac_Ip_BufferType customMessage_UDP_1400 = { .Data = udpFrame1400, .Length = 14 + 20 + 8 + 1400 };
