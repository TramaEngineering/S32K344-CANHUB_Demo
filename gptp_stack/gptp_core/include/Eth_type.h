...
typedef enum
{
    ETH_S_UNINIT = 0, /**< The driver has not been initialized yet */
    ETH_S_INIT        /**< The driver has not been configured and
...
typedef enum
{
    ETH_M_DOWN                       = 0U, /**< Controller is shut down */
    ETH_M_ACTIVE                     = 1U, /**< Controller is active */
    ETH_M_ACTIVE_WITH_WAKEUP_REQUEST = 2U  /**< Controller is active with wakeup request. */
}  Eth_ModeType_g;
...
typedef enum
{
    ETH_REC = 0,   /**< A frame has been received and there are no more frames in the queue */
    ETH_NOT_REC,   /**< No frames received */
    ETH_REC_MORE_DATA_AVAILABLE /**< A frame received and at least another one in the queue detected */
} Eth_RxStatusType_g;
...
typedef enum
{
    ETH_ADD_TO_FLT = 0,    /**< Add address to the filter */
    ETH_REMOVE_FROM_FLT    /**< Remove address */
} Eth_FilterActionType_g;
...
{
    ETH_VAL = 0,         /**< Success */
    ETH_INVAL,       /**< General failure */
    ETH_UNCERT     /**< Ethernet hardware access failure */
}  Eth_TimeStampQualType_g;
...
typedef enum
{
    ETHTRCV_MODE_DW = 0,    /**<  Transceiver disabled */
    ETHTRCV_MODE_ACT        /**<  Transceiver enable */
} EthTrcv_ModeType_g;
/**
...
typedef enum
{
    ...
    ETHTRCV_LINK_ST_DOWN = (uint8)0x0U,
    /**< @brief Physical Ethernet connection established. */
    ETHTRCV_LINK_ST_ACTIVE  = (uint8)0x1U

} EthTrcv_LinkStateType_g;
...
typedef enum
{
    ...
    ETHTRCV_ST_UNINIT = (uint8)0x0U,
    /**< @brief Driver is configured. */
    ETHTRCV_ST_INIT  = (uint8)0x1U
...
typedef enum
{
    ...
    ETHTRCV_B_RATE_10MBIT = (uint8)0x0U,
    /**< @brief 100MBIT Ethernet connection */
    ETHTRCV_B_RATE_100MBIT  = (uint8)0x1U,
    /**< @brief 1000MBIT Ethernet connection */
    ETHTRCV_B_RATE_1000MBIT = (uint8)0x2U,
    /**< @brief 2500MBIT Ethernet connection */
    ETHTRCV_B_RATE_2500MBIT

} EthTrcv_BaudRateType_g;
...
typedef enum
{
    ...
    ETHTRCV_DUPLEX_M_HALF = (uint8)0x0U,
    /**< @brief Full duplex Ethernet connection */
    ETHTRCV_DUPLEX_M_FULL  = (uint8)0x1U

} EthTrcv_DuplexModeType_g;
...
typedef enum
{
    ...
    ETHTRCV_WUM_DIS = (uint8)0x0U,
    /**< @brief Transceiver wake up enabled */
    ETHTRCV_WUM_EN  = (uint8)0x1U,
    /**< @brief Transceiver wake up reason cleared. */
    ETHTRCV_WUM_CLR

} EthTrcv_WakeupModeType_g;
...
Only available if EthTrcvWakeupSleepOn DatalineEnabled is set to TRUE */
    ETHTRCV_WUR_WODL_WP  = (uint8)0x8U,
...
Only available if EthTrcvWakeupSleepOnDataline Enabled is set to TRUE */
    ETHTRCV_WUR_WODL_WR  = (uint8)0x9U,
...
Only available if EthTrcvWakeupSleepOn DatalineEnabled is set to TRUE. */
    ETHTRCV_WUR_TRANS  = (uint8)0xAU

} EthTrcv_WakeupReasonType_g;
...
typedef enum
{
    ...
    ETHTRCV_PHYTESTM_NONE = (uint8)0x0U,
    /**< @brief test transmitter droop */
    ETHTRCV_PHYTESTM_1  = (uint8)0x1U,
    /**< @brief test master timing jitter */
    ETHTRCV_PHYTESTM_2  = (uint8)0x2U,
    /**< @brief test slave timing jitter */
    ETHTRCV_PHYTESTM_3  = (uint8)0x3U,
    /**< @brief test transmitter distortion */
    ETHTRCV_PHYTESTM_4  = (uint8)0x4U,
    /**< @brief test power spectral density (PSD) mask */
    ETHTRCV_PHYTESTM_5  = (uint8)0x5U

} EthTrcv_PhyTestModeType_g;
...
{
    /**< @brief normal operation */
    ETHTRCV_PHYLOOPB_NONE = (uint8)0x0U,
    /**< @brief internal loopback */
    ETHTRCV_PHYLOOPB_INTERNAL  = (uint8)0x1U,
    /**< @brief external loopback */
    ETHTRCV_PHYLOOPB_EXTERNAL  = (uint8)0x2U,
    /**< @brief remote loopback */
    ETHTRCV_PHYLOOPB_REMOTE  = (uint8)0x3U

} EthTrcv_PhyLoopbackModeType_g;
...
{
    /**< @brief normal operation */
    ETHTRCV_PHYTXM_NORMAL = (uint8)0x0U,
    /**< @brief transmitter disabled */
    ETHTRCV_PHYTXM_TX_OFF  = (uint8)0x1U,
    /**< @brief scrambler disabled */
    ETHTRCV_PHYTXM_SCRAMBLER_OFF  = (uint8)0x2U

} EthTrcv_PhyTxModeType_g;
...
typedef enum
{
    ETHSWT_ST_UNINIT             = (uint8)0x0U, /**< @brief The Eth Switch Driver is not yet configured. */
    ETHSWT_ST_INIT               = (uint8)0x1U, /**< @brief The Eth Switch Driver is configured */
    ETHSWT_ST_PORTINIT_COMPLETED = (uint8)0x2U, /**< @brief Port initialization is completed. */
    ETHSWT_ST_ACTIVE             = (uint8)0x3U  /**< @brief The Eth Switch driver is active. */
} EthSwt_StateType_g;
...
typedef enum
{
    ETHSWT_MACLEARN_HWDISABLED  = (uint8)0x0U, /**< @brief If hardware learning disabled, the switch must not learn new MAC addresses */
    ETHSWT_MACLEARN_HWENABLED   = (uint8)0x1U, /**< @brief If hardware learning enabled, the switch learns new MAC addresses */
    ETHSWT_MACLEARN_SWENABLED   = (uint8)0x2U  /**< @brief If software learning enabled, the hardware learning is disabled and the switch forwards packets  with an unknown source address to a host CPU */
} EthSwt_MacLearningType_g;
...
typedef enum
{
    PORT_MIRR_DISABLED = (uint8)0x0U, /**< @brief port mirroring disabled. */
    PORT_MIRR_ENABLED  = (uint8)0x1U  /**< @brief port mirroring enabled. */
} EthSwt_PortMirrorStateType_g;
...
typedef enum
{
    ETHSWT_MGMT_OBJ_UNUSE               = (uint8)0x0U, /**< @brief Object unused */
    ETHSWT_MGMT_OBJ_OWN_BY_ETHSWT      = (uint8)0x1U, /**< @brief Object used and EthSwt collects needed data */
    ETHSWT_MGMT_OBJ_OWN_BY_UPPER_LAYER = (uint8)0x2U  /**< @brief Object used and the upper layer does calculations */
} EthSwt_MgmtOwner_g;
...
*/
typedef uint16 Eth_FrameType_g;
...
*/
typedef uint32 Eth_BufIdxType_g;
...
typedef struct
{
    Eth_TimeStampType_g diff;   /**< @brief diff time difference */
    boolean sign;       /**< @brief Positive (True) Or negative (False) time */
} Eth_TimeIntDiffType_g;
...
typedef struct
{
    Eth_TimeIntDiffType_g IngressTimeStampDelta;   /**< @brief   IngressTimeStampSync2 -IngressTimeStampSync1 */
    Eth_TimeIntDiffType_g OriginTimeStampDelta;       /**< @brief OriginTimeStampSync2[FUP2]-OriginTimeStampSync1[FUP1] */
} Eth_RateRatioType_g;
...
}Eth_TxErrorCounterValuesType_g;
...
typedef struct
{
    EthSwt_MgmtObjectValidType_g    Validation;         /**< @brief The validation information for the mgmt_obj. */
    Eth_TimeStampType_g             IngressTimestamp;   /**< @brief The ingress timestamp value out of the switch. */
    Eth_TimeStampType_g             EgressTimestamp;    /**< @brief The egress timestamp value out of the switch. */
    EthSwt_MgmtInfoType_g           MgmtInfo;           /**< @brief Received/Transmitted Management information of the switches. */
    EthSwt_MgmtOwner_g              Ownership;          /**< @brief The ownership of MgmtObj. */
} EthSwt_MgmtObjectType_g;
/*==================================================================================================
